/*
 * @Author: 史涛 
 * @Date: 2019-01-05 19:33:24 
 * @Last Modified by:   史涛 
 * @Last Modified time: 2019-01-05 19:33:24 
 */
...
const SWITCH_LAYERS='SWITCH_LAYERS';
...
module.exports = {
    ...
    updateNode, layerLoading, layerLoad, layerError, addLayer, removeLayer, showSettings, hideSettings, updateSettings, refreshLayers,switchLayers,
    ...
    SHOW_SETTINGS, HIDE_SETTINGS, UPDATE_SETTINGS, CONTEXT_NODE, REFRESH_LAYERS,SWITCH_LAYERS, LAYERS_REFRESHED, LAYERS_REFRESH_ERROR, UPDATE_LAYERS_DIMENSION, BROWSE_DATA, DOWNLOAD,
