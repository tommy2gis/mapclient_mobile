 ...
 * @Last Modified by:   史涛 
 * @Last Modified time: 2019-01-05 19:33:41 
 */
var PropTypes = require('prop-types');
import Coordinates from '../../utils/map/Coordinates'
var React = require('react');
var L = require('leaflet');

class CoordinatesControl extends React.Component {
    static propTypes = {
    ...
    componentDidMount() {
        this.coord = new Coordinates(this.props);
        if (this.props.map) {
...
module.exports = CoordinatesControl;