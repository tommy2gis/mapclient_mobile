/*
 * @Author: 史涛 
 * @Date: 2019-01-05 19:31:03 
 * @Last Modified by:   史涛 
 * @Last Modified time: 2019-01-05 19:31:03 
 */


var { LAYER_LOADING, LAYER_LOAD, LAYER_ERROR, CHANGE_LAYER_PARAMS, CHANGE_LAYER_PROPERTIES, CHANGE_GROUP_PROPERTIES,SWITCH_LAYERS,
...
function layers(state = null, action) {
    switch (action.type) {
        /* case TOGGLE_CONTROL: {
